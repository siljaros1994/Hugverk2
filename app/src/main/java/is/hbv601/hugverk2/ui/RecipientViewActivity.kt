...
class RecipientViewActivity :AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Get recipientProfileId passed from the donor card button
    ...
    private fun updateUI(recipient: RecipientProfile) {
        ...
        tvMedicalHistory.text = "Medical History: ${recipient.medicalHistory?.joinToString(", ") ?: "Not specified"}"
        ...
        // Load recipient image with Glide
